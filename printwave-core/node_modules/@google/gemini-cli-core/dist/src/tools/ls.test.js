...
describe('LSTool', () => {
    ...
    describe('parameter validation', () => {
        ...
        it('should reject paths outside workspace with clear error message', () => {
            ...
            const error = lsTool.validateToolParams(params);
            expect(error).toBe('Path must be within one of the workspace directories: /home/user/project, /home/user/other-project');
        });
    ...
    describe('execute', () => {
        it('should list files in a directory', async () => {
            ...
            const result = await lsTool.execute({ path: testPath }, new AbortController().signal);
        ...
        it('should respect ignore patterns', async () => {
            ...
            vi.mocked(fs.readdirSync).mockReturnValue(mockFiles);
            const result = await lsTool.execute({ path: testPath, ignore: ['*.spec.js'] }, new AbortController().signal);
        ...
        it('should validate parameters and return error for invalid params', async () => {
            const result = await lsTool.execute({ path: '../outside' }, new AbortController().signal);
    ...
    describe('workspace boundary validation', () => {
        ...
        it('should reject paths outside all workspace directories', () => {
            ...
            const error = lsTool.validateToolParams(params);
            expect(error).toContain('Path must be within one of the workspace directories');
