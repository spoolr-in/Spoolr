...
describe('bfsFileSearch', () => {
    ...
    it('should perform parallel directory scanning efficiently (performance test)', async () => {
        ...
        console.log(`🏎️  Processing ~${Math.round(200 / (avgDuration / 1000))} dirs/second`);
        ...
        console.log(`✅ Performance test passed: avg=${avgDuration.toFixed(2)}ms, consistency=${(consistencyRatio * 100).toFixed(1)}% (threshold: ${(maxConsistencyRatio * 100).toFixed(0)}%)`);
    });
});
